...
This directory contains the backend code and supporting configuration for the Image AI Tutorial application. It implements the core APIs, business logic, data models, workflows, and infrastructure needed to scan images, generate reports, manage users, and support active learning.
